...
from step_2_dataset import SignLanguageMNIST
...
def validate():
    trainloader, testloader = SignLanguageMNIST.get_train_test_loaders()
    net = Net().float().eval()
    ...
    trainloader, testloader = SignLanguageMNIST.get_train_test_loaders(1)
